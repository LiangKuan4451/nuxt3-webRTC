        ...
        <div class="hero-content flex-col lg:flex-row-reverse">
            ...
            <div class="w-full ">
                ...
                <div class="flex gap-4">
                    ...
                    <NuxtLink to="/info" class="btn btn-outline">关于我</NuxtLink>
                </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button class="btn btn-primary" v-for="contact in contactInfo" :key="contact.name" @click="handleContactClick(contact)">
                    ...
                    <div class="space-y-4">
                        <div v-for="tech in techStack" :key="tech.name" class="tech-item">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                                <div class="h-2.5 rounded-full" :class="getProficiencyColorClass(tech.proficiency)" :style="{ width: tech.proficiency + '%' }"></div>
                            </div>
                        </div>
                    </div>
                </div>
